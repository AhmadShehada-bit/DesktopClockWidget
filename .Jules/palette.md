...
## 2026-09-18 - Ambiguous Button Text for Screen Readers
**Learning:** Buttons with generic text like "Choose..." lack context for screen reader users when removed from their visual grouping.
**Action:** Always use the three-argument `CreateStyledButton` overload to provide a descriptive tooltip and `AutomationProperties.Name` for icon-only or generic-text buttons.
